...
bool fts_check_app_bin(u8 *pbt_buf, u32 dw_lenth)
{
	...
	// 2 PART1 ECC
	if (!task_check_mem_ecc(pbt_buf, APP_ADDR_PART1_START,
				APP_ADDR_PART1_LEN, ADDR_PART1_ECC)) {
...
#define APP_ADDR_PART2_START                                                   \
	((APP_ADDR_START) + (APP_VERIF_ADDR) + (APP_VERIF_LEN) +               \
	 (FW_CFG_TOTAL_SIZE))
