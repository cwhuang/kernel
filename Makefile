...
KBUILD_CFLAGS   += -DAAEON_BOARD_NAME=\"$(TARGET_PRODUCT)\" -DBUILD_VERSION=\"$(BUILD_NUMBER)\"
KBUILD_CFLAGS   += $(if $(DEBIAN_VERSION),-DDEBIAN_VERSION=\"$(DEBIAN_VERSION)\")
KBUILD_CFLAGS   += $(if $(PLATFORM_VERSION),-DPLATFORM_VERSION=\"$(PLATFORM_VERSION)\")
